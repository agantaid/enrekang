const PrivacyPolicy = () => {
  return (
    <>
      <h1>Privacy Policy for DISPOPAR ENREKANG</h1>

      <p>
        At DISPOPAR ENREKANG, accessible from https://www.dispoparenrekang.id/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by DISPOPAR ENREKANG and how we use it.
      </p>
      ...
      <p>
        DISPOPAR ENREKANG follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on DISPOPAR
        ENREKANG, which are sent directly to users&#39; browser. They automatically receive your IP
      ...
      <p>
        Note that DISPOPAR ENREKANG has no access to or control over these cookies that are used by
      ...
      <p>
        DISPOPAR ENREKANG&#39;s Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        DISPOPAR ENREKANG does not knowingly collect any Personal Identifiable Information from
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in DISPOPAR
        ENREKANG. This policy is not applicable to any information collected offline or via channels
